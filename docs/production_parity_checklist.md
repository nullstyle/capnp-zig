...
- 2026-02-08: Continued RPC duplication cleanup by centralizing promised-answer op-slice copying in `src/rpc/level1/promised_answer_copy.zig` and reusing it from `src/rpc/level0/cap_table.zig`; added alias-safety coverage in `tests/rpc/level0/rpc_cap_table_encode_test.zig`.
