...
- 2026-02-08: Expanded `src/rpc/level2/transport.zig` failure-path coverage with EOF-close signaling, explicit close-error propagation, and write-completion behavior when callback context is missing.
