...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.11.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.11.0",
        .hash = "capnpc_zig-0.11.0-nUduFQxyNQC72_Ycs246iLh4hYBw5JuTomFArKtZQPN9",
    },
},
```
