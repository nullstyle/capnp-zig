...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.8.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.8.0",
        .hash = "capnpc_zig-0.8.0-nUduFcXDKQD867-Wt_Tl-ZZUKrXR3HZQeVoQMZ-UH_wV",
    },
},
```
