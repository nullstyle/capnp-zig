...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.6.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.6.0",
        .hash = "capnpc_zig-0.6.0-nUduFTfNJwC0BmLIP13pXdiQ_GgKh58qQlh0BuklJQqI",
    },
},
```
