...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.13.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.13.0",
        .hash = "capnpc_zig-0.13.0-nUduFf0lNgCaVVQ9o0GaglInZ30FjqCq0HBI5PREoDjq",
    },
},
```
