...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.16.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.16.0",
        .hash = "capnpc_zig-0.16.0-nUduFXLZNgAmDvsQZOn7lNOEtNbRBYquaALRB24zUAvS",
    },
},
```
