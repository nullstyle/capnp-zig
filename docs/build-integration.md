...
```sh
zig fetch --save git+https://github.com/nullstyle/capnp-zig.git#v0.9.0
```
...
.dependencies = .{
    .capnpc_zig = .{
        .url = "git+https://github.com/nullstyle/capnp-zig.git#v0.9.0",
        .hash = "capnpc_zig-0.9.0-nUduFQ_aKQBHO9AmYl_CWVkfuifiE1vrnLkz6LI1Yt8B",
    },
},
```
