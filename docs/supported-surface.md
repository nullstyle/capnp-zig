# Supported Surface (v0.14.0)

This is the authoritative statement of what `capnpc-zig` promises a consumer at
v0.14.0 — which modules are stable, what the RPC implementation conforms to, the
...
version (`zig fetch --save …#v0.14.0`) and read the CHANGELOG before bumping.
