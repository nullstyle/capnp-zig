...
pub const _internal = struct {
    ...
    pub const pending_calls = @import("./promises/pending_calls.zig");
    pub const return_routing = @import("./promises/return_routing.zig");
    pub const return_send = @import("./promises/return_send.zig");
