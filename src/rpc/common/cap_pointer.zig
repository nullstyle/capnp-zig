...
///
/// Cap'n Proto capability pointers have tag bits 0b11 in the lowest two bits,
/// with the capability index in the upper 32 bits.
...
pub fn writePointerWord(builder: *message.MessageBuilder, segment_id: u32, pointer_pos: usize, word: u64) !void {
